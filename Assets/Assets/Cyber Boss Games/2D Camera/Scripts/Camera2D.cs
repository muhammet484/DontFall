...
public class Camera2D : MonoBehaviour
{
    ...
    private float cameraDefaultOrtographicSize;
    ...
    void Awake()
    {
        ...
        cameraDefaultOrtographicSize = cam.orthographicSize;
    }
    ...
    private void MutliTargetAutoZoom() {
        ...
        if(targets.Count == 1)
        {
            cam.orthographicSize = Mathf.Lerp(cam.orthographicSize, cameraDefaultOrtographicSize, Time.deltaTime * multiTargetAutoZoomDampening);
        }
    }
